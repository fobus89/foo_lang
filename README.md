...
### Макросы
Полнофункциональная система макросов с поддержкой AST манипуляций.
...
### Структуры и метапрограммирование
Полнофункциональная система типов с поддержкой метапрограммирования.
